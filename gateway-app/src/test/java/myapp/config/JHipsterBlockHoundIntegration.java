...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("myapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("myapp.security.DomainUserDetailsService", "createSpringSecurityUser");
